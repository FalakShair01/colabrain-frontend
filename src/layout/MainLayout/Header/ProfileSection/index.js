...
// assets
import { IconLogout, IconSettings, IconMail, IconRocket } from '@tabler/icons';
    ...
    useEffect(() => {
        axios
            ...
            .then((response) => {
                ...
                setRole(data.role || '');
                setProfile(data.profile_pic || null);
            })
            .catch((error) => {
                        ...
                        <Paper>
                            <ClickAwayListener onClickAway={handleClose}>
                                <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                                    <Box sx={{ p: 2 }}>
                                        <Stack>
                                            <Stack direction="row" spacing={0.5} alignItems="center" style={{ mb: '3' }}>
                                            ...
                                            <Stack direction="row" spacing={0.5} alignItems="center">
                                                <IconMail stroke={1.5} size="0.8rem" />
                                                <Typography variant="subtitle2">{email}</Typography>
                                            </Stack>
                                            <Stack direction="row" spacing={0.5} alignItems="center">
                                                <IconRocket stroke={1.5} size="0.8rem" />
                                        ...
                                        <Box sx={{ p: 2 }}>
                                            ...
                                            >
                                                ...
                                                <ListItemButton
                                                    ...
                                                    onClick={(event) => handleListItemClick(event, 1, '/logout')}
                                                >
                                                    <ListItemIcon>
